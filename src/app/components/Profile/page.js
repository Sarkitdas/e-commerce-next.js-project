            ...
            <div className="relative px-8 pb-8">
              ...
              <div className="mt-10 grid grid-cols-2 gap-4">
                <button 
                   ...
                   className="flex items-center justify-center gap-2 py-4 px-6 bg-gray-50 text-rose-700 rounded-2xl font-bold text-sm hover:bg-gray-150 transition-all active:scale-95 cursor-pointer"
                >
